...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.lbl_result.setGeometry(QtCore.QRect(10, 20, 771, 551))
        ...
        self.lbl_threshold = QtWidgets.QLabel(self.frame_2)
        self.lbl_threshold.setGeometry(QtCore.QRect(10, 600, 381, 161))
        self.lbl_threshold.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.lbl_threshold.setFrameShape(QtWidgets.QFrame.Box)
        ...
        self.lbl_contour.setGeometry(QtCore.QRect(400, 600, 381, 161))
    ...
    def retranslateUi(self, Frame):
        ...
        self.lbl_threshold.setText(_translate("Frame", "threshold"))
        ...
        self.lbl_contour.setText(_translate("Frame", "contour"))
